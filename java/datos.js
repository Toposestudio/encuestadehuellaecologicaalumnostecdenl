        ...
        */
        ...
        if (catMa == 0) {
            ...
            if (a == catMa) {
                ...
                valcat = '<p class="cuerpo suelo">Te recomendamos <span class="cuerpo cate">reducir</span> las compras de productos con mucho envoltorio, <span class="cuerpo cate">reutilizar</span> al máximo bolsas plásticas, envases de vidrio, hojas de papel y otros materiales, y <span class="cuerpo cate">reciclar</span> separando tu basura.</p>';
            } else if (c == catMa) {
